...
namespace fsm
{
    ...
    dfa *nfa_to_dfa(nfa n)
    {
        ...
        for (auto &s : state_set)
        {
            for (auto &alpha : n.S)
            {
                ...
                d->insert_alphabetransition(concatState(s), alpha.first, next);
            }
        }
        // d->out();
        return d;
    ...
    dfa *concat_dfa(dfa &d1, dfa &d2)
    {
        ...
        for (auto q : d1.Q)
        {
            for (auto a : d1.S)
            {
                ...
                {
                    n.insert_alphabetransition("1@" + q, a.first, "1@" + d1.delta[q][a.first]);
                }
            }
        }
        ...
        for (auto q : d2.Q)
        {
            for (auto a : d2.S)
            {
                ...
                {
                    n.insert_alphabetransition("2@" + q, a.first, "2@" + d2.delta[q][a.first]);
                }
            }
        }
        ...
        for (auto q : d1.F)
        {
            n.insert_alphabetransition("1@" + q, "\\e", "2@" + d2.q0);
        }
        return nfa_to_dfa(n);
    }
    ...
    dfa *union_dfa(dfa &d1, dfa &d2)
    {
        ...
        n.insert_state("q0");
        n.change_start("q0");
        n.insert_alphabetransition("q0", "\\e", "1@" + d1.q0);
        n.insert_alphabetransition("q0", "\\e", "2@" + d2.q0);
    ...
    dfa *kleene_dfa(dfa &d1)
    {
        ...
        n.change_start("@q0");
        n.insert_final("@q0");
        n.insert_alphabetransition("@q0", "\\e", d1.q0);
        for (auto q : d1.Q)
        {
            for (auto a : d1.S)
            {
                if (d1.delta[q].find(a.first) != d1.delta[q].end())
                {
                    n.insert_alphabetransition(q, a.first, d1.delta[q][a.first]);
                }
            }
        }
        for (auto q : d1.F)
        {
            n.insert_alphabetransition(q, "\\e", d1.q0);
        }
        return nfa_to_dfa(n);
    }
    ...
    nfa *concat_nfa(nfa &n1, nfa &n2)
    {
        ...
        for (auto q : n1.Q)
        {
            for (auto a : n1.S)
            {
                ...
                {
                    n->insert_alphabetransition("1@" + q, a.first, "1@" + i->second);
                }
            }
        }
        ...
        for (auto q : n2.Q)
        {
            for (auto a : n2.S)
            {
                ...
                for (auto i = it.first; i != it.second; i++)
                {
                    n->insert_alphabetransition("2@" + q, a.first, "2@" + i->second);
                }
            }
        }
        ...
        for (auto q : n1.F)
        {
            n->insert_alphabetransition("1@" + q, "\\e", "2@" + n2.q0);
        }
    ...
    nfa *union_nfa(nfa &n1, nfa &n2)
    {
        ...
        n->insert_state("q0");
        n->change_start("q0");
        n->insert_alphabetransition("q0", "\\e", "1@" + n1.q0);
        n->insert_alphabetransition("q0", "\\e", "2@" + n2.q0);
    ...
    nfa *kleene_nfa(nfa &n1)
    {
        ...
        n->change_start("@q0");
        n->insert_final("@q0");
        n->insert_alphabetransition("@q0", "\\e", n1.q0);
        for (auto q : n1.Q)
        {
            for (auto a : n1.S)
            {
                ...
                for (auto i = it.first; i != it.second; i++)
                {
                    n->insert_alphabetransition(q, a.first, i->second);
                }
            }
        }
        for (auto q : n1.F)
        {
            n->insert_alphabetransition(q, "\\e", n1.q0);
        }
        return n;
    }
