...
int main(){
    ...
    d1.add_transition("q0", "b", "q0");
    d1.add_transition("q1", "a", "q2");
    d1.add_transition("q1", "b", "q1");
    d1.add_transition("q2", "b", "q2");
    d1.add_transition("q2", "a", "q1");
    ...
    d2.add_transition("x0", "a", "x1");
    d2.add_transition("x0", "b", "x0");
    d2.add_transition("x1", "a", "x2");
    d2.add_transition("x1", "b", "x1");
    d2.add_transition("x2", "b", "x2");
    d2.add_transition("x2", "a", "x1");
