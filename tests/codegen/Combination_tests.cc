...
int main()
{
    ...
    //Initializing states of dfa d
     ...
     //Initializing statr state of dfa d
        ...
        d.insert_transition("q0","a","q1");
        d.insert_transition("q1","a","q2");
        d.insert_transition("q2","a","q0");
...
// cout << "HELLO" << endl;
       ...
       //Testing Intersection of dfa d and dfa d1
        ...
        n.insert_transition("q1","b","q2");

        //Initializing transitions of nfa n1

        n1.insert_transition("q0","a","q1");
        n1.insert_transition("q1","b","q2");
...
//     d.insert_transition("q0", "a", "q1");
//     d.insert_transition("q0", "b", "q0");
//     d.insert_transition("q1", "a", "q2");
//     d.insert_transition("q1", "b", "q1");
//     d.insert_transition("q2", "b", "q2");
...
// //     d.out();
//     d.insert_transition("q0", "c", "q0");
//     d.insert_transition("q1", "c", "q1");
//     d.insert_transition("q2", "c", "q2");
//     d.insert_transition("q3", "c", "q3");
//     d.insert_transition("q3", "a", "q1");
//   //   d.out();
//      d.remove_final("q1");
...
//    d.insert_transition("q4", "a", "q3");
//     d.insert_transition("q4", "c", "q3");
//     d.insert_transition("q2", "c", "q4");
//     d.insert_transition("q3", "a", "q3");
//     d.insert_transition("q0", "a", "q0");
...
// //     cout << d.insert_transition("q5", "a", "q6") << endl;

// //     // This should return false as there is no alphabet "d".
//  //    cout << d.insert_transition("q3", "d", "q5") << endl;

// //     // This should return false as q1 has been deleted.
//  //    cout << d.insert_transition("q5", "a", "q1") << endl;
     

//      d.insert_transition("q3", "a", "q5");
//  //    d.out();
// //     // Should return false.
